...
public class DAOSatisfaction {
    public static void ajoutClient(Satisfaction satisfaction) {
        ConnectionBDD.creerConnection();
        try {
            String requete = "INSERT INTO Satisfaction (note,commentaire,dateSatisfaction,IdDocument,IdEvenement) VALUES (?,?,?,?,?);";
    ...
    public static void modificationClient(Satisfaction satisfaction) {
        ConnectionBDD.creerConnection();
        try {
            String requete = "UPDATE Satisfaction SET note = ?,commentaire = ?,dateSatisfaction = ?,IdDocument = ?,IdEvenement = ? WHERE Id = ?;";
            PreparedStatement preparedStatement = ConnectionBDD.connection.prepareStatement(requete);
    ...
    public static void suppressionClient(Satisfaction satisfaction) {
        ConnectionBDD.creerConnection();
        try {
            String requete = "DELETE FROM Satisfaction WHERE Id = ?;";
            PreparedStatement preparedStatement = ConnectionBDD.connection.prepareStatement(requete);
    ...
    public static ArrayList<Satisfaction> getListSatisfactions() {
        ...
        ConnectionBDD.creerConnection();
        try {
            String requete = "SELECT note,commentaire,dateSatisfaction,IdDocument,IdEvenement FROM Satisfaction;";
            PreparedStatement preparedStatement = ConnectionBDD.connection.prepareStatement(requete);
    ...
    public static Satisfaction getClient(long Id) {
